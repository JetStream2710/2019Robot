...
//  private Logger logger = new Logger(CalibratePosition.class.getName());
  ...
  //  logger.warning(String.format("Recalibrated level: %d arm: %d swivel: %d elevator %d, previous: arm %d swivel %d elevator %d",Robot.arm.getLevel(), Robot.arm.getVerticalArmPosition(), Robot.arm.getSwivelPosition(), Robot.elevator.getPosition(), arm, swivel, elevator));
  }
